...
-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('DRAFT', 'PENDING', 'ACTIVE', 'REJECTED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('FREE', 'EARLY_BIRD', 'REGULAR', 'VIP', 'VVIP');

-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'WAITING_FOR_PAYMENTS', 'WAITING_FOR_CONFIRMATION', 'REJECTED', 'DONE', 'CANCELLED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'SUCCESS', 'FAILED');

-- CreateEnum
CREATE TYPE "PromoType" AS ENUM ('REFERRAL', 'EVENT_VOUCHER');

-- CreateEnum
CREATE TYPE "EventCategory" AS ENUM ('KONSER', 'WORKSHOP', 'SEMINAR', 'FESTIVAL', 'OLAHRAGA', 'LAINNYA');
...
CREATE TABLE "Events" (
    ...
    "description" TEXT,
    "category" "EventCategory" NOT NULL DEFAULT 'LAINNYA',
    "location" VARCHAR,
