        ...
        {submitted ? (
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Jika email <strong>{email}</strong> terdaftar, link reset password telah dikirim. Periksa kotak masuk Anda.
            </p>
            <p className="text-xs text-gray-400 mb-6">Link berlaku selama 15 menit.</p>
            <Link
              to="/login"
